...
alerts_brazil_handler = CommandHandler(('alertas', 'alertas_brasil', 'avisos'),
                                       bot_functions.cmd_alerts_brasil, filters=~Filters.update.edited_message)
...
alerts_map_handler = CommandHandler(('mapa', 'alertas_mapa', 'mapa_alertas', 'mapa_avisos'),
                                    bot_functions.cmd_alerts_map, filters=~Filters.update.edited_message)
chat_subscribe_alerts_handler = CommandHandler(
    ('inscrever_alertas', 'alertas_inscrever', 'inscrever'), bot_functions.cmd_chat_subscribe_alerts, filters=~Filters.update.edited_message)
chat_unsubscribe_alerts_handler = CommandHandler(('desinscrever_alertas', 'alertas_desinscrever',
                                                  'desinscrever'), bot_functions.cmd_chat_unsubscribe_alerts, filters=~Filters.update.edited_message)
chat_subscription_status_handler = CommandHandler(
    ('inscrito', 'status'), bot_functions.cmd_chat_subscription_status, filters=~Filters.update.edited_message)

deactivate_handler = CommandHandler(
    ('desativar'), bot_functions.cmd_chat_deactivate)
...
sorrizoronaldo_handler = CommandHandler(('sorrizo', 'sorrizoronaldo', 'fodase'),
                                        bot_functions.cmd_sorrizoronaldo, filters=~Filters.update.edited_message)
