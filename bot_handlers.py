...
chat_subscribe_alerts_handler = CommandHandler(('inscrever_alertas', 'alertas_inscrever', 'inscrever'), bot_functions.cmd_chat_subscribe_alerts, filters=~Filters.update.edited_message)
chat_unsubscribe_alerts_handler = CommandHandler(('desinscrever_alertas', 'alertas_desinscrever', 'desinscrever'), bot_functions.cmd_chat_unsubscribe_alerts, filters=~Filters.update.edited_message)
chat_subscription_status_handler = CommandHandler(('inscrito', 'status'), bot_functions.cmd_chat_subscription_status, filters=~Filters.update.edited_message)
